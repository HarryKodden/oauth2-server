...
[![CI/CD](https://github.com/eduwallet/oauth2-server/actions/workflows/ci.yml/badge.svg)](https://github.com/eduwallet/oauth2-server/actions/workflows/ci.yml)
...
[![Docker Image](https://img.shields.io/docker/v/eduwallet/oauth2-server?sort=semver)](https://hub.docker.com/r/eduwallet/oauth2-server)
